...
extern const int16_t ppg1_stimulus[10000];
extern const unsigned int ppg1_stimulus_len;

extern const int16_t ppg2_stimulus[10000];
extern const unsigned int ppg2_stimulus_len;
