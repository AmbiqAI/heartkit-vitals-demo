...
int main(void)
{
    ...
    CHECK_NEAR(MCU_INFERENCE_POWER_MW_LP, 5.5f, 0.0001f);
    CHECK_NEAR(MCU_INFERENCE_POWER_MW_HP, 16.7f, 0.0001f);
    CHECK_NEAR(hp.sleep_mw, 0.75f, 0.0001f);
    CHECK_NEAR(hp.compute_mw, 11.7f, 0.0001f);
    ...
    CHECK_NEAR(r.average_mw, 2.49380375f, 0.0001f);
    CHECK_NEAR(r.days, 22.55590481f, 0.001f);
